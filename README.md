...
### Собранный образ
Доступен по адресу: https://hub.docker.com/r/acherepkov/silk_road

Скачать можно следующей командой: `docker pull acherepkov/silk_road`

### Как контрольную компиляцию всего этого добра делать - не написано
